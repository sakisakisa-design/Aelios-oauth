    ...
    <main class="min-w-0 flex-1 px-4 py-4 md:px-6">
      ...
      <section x-show="page === 'settings'" class="space-y-4">
        ...
        <article class="rounded-2xl border border-zinc-800 bg-zinc-900 p-4 shadow-sm">
          ...
          <p class="mt-1 text-[11px] leading-5 text-zinc-500">chat 走 compat;带 provider/ 前缀的 messages / responses 走 AI Gateway。Worker Secret 若有 CLAUDE_OAUTH_TOKEN，无前缀的 /v1/messages 直打 Anthropic，不进 AI Gateway。</p>
